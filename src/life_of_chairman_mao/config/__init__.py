...
_external_files = [
    Path(sys.prefix, 'etc', 'life_of_chairman_mao', 'settings.yml')
]


settings = Dynaconf(
    # Set env `LIFE_OF_CHAIRMAN_MAO_FOO='bar'`，use `settings.FOO` .
    envvar_prefix='LIFE_OF_CHAIRMAN_MAO',
    ...
    # env_switcher='LIFE_OF_CHAIRMAN_MAO_ENV',
